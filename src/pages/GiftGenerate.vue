...
<style>
.gift .q-dialog__title {
  text-align: center;
  color: grey;
}

.gift .q-dialog__message {
  text-align: center;
  font-size: 14pt;
  font-weight: bold;
